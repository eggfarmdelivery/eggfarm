...
## 마이그레이션 순서
0001_init → 0002_seed → 0003_auth → 0004_storage → 0005_address_fields → 0006_product_photo → 0007_settings → 0008_order_status_prep → 0009_notice → 0010_cancel_refund_status → 0011_status_log → 0012_refund_column → 0013_credit_used
